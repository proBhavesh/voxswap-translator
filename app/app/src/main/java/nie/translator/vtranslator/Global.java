...
public class Global extends Application implements DefaultLifecycleObserver {
    ...
    /* Audio device preferences — sentinel: -1 = not loaded from prefs, 0 = system default */
    private static final String PREF_INPUT_DEVICE_ID = "audioInputDeviceId";
    private static final String PREF_INPUT_DEVICE_NAME = "audioInputDeviceName";
    private static final String PREF_INPUT_DEVICE_TYPE = "audioInputDeviceType";
    private static final String PREF_OUTPUT_DEVICE_ID = "audioOutputDeviceId";
    private static final String PREF_OUTPUT_DEVICE_NAME = "audioOutputDeviceName";
    private static final String PREF_OUTPUT_DEVICE_TYPE = "audioOutputDeviceType";
    private int preferredInputDeviceId = -1;
    private String preferredInputDeviceName = null;
    private int preferredInputDeviceType = -1;
    private int preferredOutputDeviceId = -1;
    ...
    /* Audio device preferences — input */

    public int getPreferredInputDeviceId() {
        if (preferredInputDeviceId == -1) {
            final SharedPreferences sharedPreferences = this.getSharedPreferences("default", Context.MODE_PRIVATE);
            preferredInputDeviceId = sharedPreferences.getInt(PREF_INPUT_DEVICE_ID, 0);
            preferredInputDeviceName = sharedPreferences.getString(PREF_INPUT_DEVICE_NAME, null);
            preferredInputDeviceType = sharedPreferences.getInt(PREF_INPUT_DEVICE_TYPE, -1);
        }
        return preferredInputDeviceId;
    }

    public String getPreferredInputDeviceName() {
        getPreferredInputDeviceId();
        return preferredInputDeviceName;
    }

    public int getPreferredInputDeviceType() {
        getPreferredInputDeviceId();
        return preferredInputDeviceType;
    }

    public void setPreferredInputDevice(int deviceId, @Nullable String productName, int deviceType) {
        preferredInputDeviceId = deviceId;
        preferredInputDeviceName = productName;
        preferredInputDeviceType = deviceType;
        final SharedPreferences sharedPreferences = this.getSharedPreferences("default", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt(PREF_INPUT_DEVICE_ID, deviceId);
        editor.putString(PREF_INPUT_DEVICE_NAME, productName);
        editor.putInt(PREF_INPUT_DEVICE_TYPE, deviceType);
        editor.apply();
    }

    /* Audio device preferences — output */

    public int getPreferredOutputDeviceId() {
        if (preferredOutputDeviceId == -1) {
            final SharedPreferences sharedPreferences = this.getSharedPreferences("default", Context.MODE_PRIVATE);
            preferredOutputDeviceId = sharedPreferences.getInt(PREF_OUTPUT_DEVICE_ID, 0);
            preferredOutputDeviceName = sharedPreferences.getString(PREF_OUTPUT_DEVICE_NAME, null);
            preferredOutputDeviceType = sharedPreferences.getInt(PREF_OUTPUT_DEVICE_TYPE, -1);
        }
        return preferredOutputDeviceId;
    }

    public String getPreferredOutputDeviceName() {
        getPreferredOutputDeviceId();
        return preferredOutputDeviceName;
    }

    public int getPreferredOutputDeviceType() {
        getPreferredOutputDeviceId();
        return preferredOutputDeviceType;
    }

    public void setPreferredOutputDevice(int deviceId, @Nullable String productName, int deviceType) {
        preferredOutputDeviceId = deviceId;
        preferredOutputDeviceName = productName;
        preferredOutputDeviceType = deviceType;
        final SharedPreferences sharedPreferences = this.getSharedPreferences("default", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt(PREF_OUTPUT_DEVICE_ID, deviceId);
        editor.putString(PREF_OUTPUT_DEVICE_NAME, productName);
        editor.putInt(PREF_OUTPUT_DEVICE_TYPE, deviceType);
        editor.apply();
    }
