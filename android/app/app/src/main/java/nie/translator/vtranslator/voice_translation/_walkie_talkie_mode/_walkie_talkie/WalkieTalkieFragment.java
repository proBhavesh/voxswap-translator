...
import nie.translator.vtranslator.LanguageSelectActivity;
import nie.translator.vtranslator.R;
import nie.translator.vtranslator.settings.SettingsActivity;
...
import nie.translator.vtranslator.tools.gui.MicrophoneComunicable;
...
import nie.translator.vtranslator.voice_translation.VoiceTranslationFragment;
...
public class WalkieTalkieFragment extends VoiceTranslationFragment implements MicrophoneComunicable {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        retryButton.setOnClickListener(v -> {
            if (walkieTalkieServiceCommunicator != null) {
                walkieTalkieServiceCommunicator.retryConnection();
    ...
    public class HomeServiceCallback extends VoiceTranslationService.VoiceTranslationServiceCallback {
        ...
        public void onBoxConnected() {
            ...
            isBoxConnected = true;
            if (!isRecording) updateConnectionUI(true);
        }
        ...
        public void onBoxDisconnected() {
            ...
            if (!isRecording) updateConnectionUI(false);
        }
