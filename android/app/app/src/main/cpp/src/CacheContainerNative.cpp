...
Java_nie_translator_vtranslator_tools_nn_CacheContainerNative_initialize(JNIEnv *env,
                                     jobject thiz,
                                     jint dim1, jint dim2,
...
Java_nie_translator_vtranslator_tools_nn_CacheContainerNative_insertValues(JNIEnv *env,
                                     jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_nie_translator_vtranslator_tools_nn_CacheContainerNative_reorder(JNIEnv *env,
                                       jobject thiz,
...
Java_nie_translator_vtranslator_tools_nn_CacheContainerNative_getBuffer(JNIEnv *env,
                                      jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_nie_translator_vtranslator_tools_nn_CacheContainerNative_close(JNIEnv *env,
                                        jobject thiz,
