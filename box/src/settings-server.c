                           ...
                           const char *lang1, const char *lang2)
{
    ...
    strncpy(settings->target_lang1, lang1, LANG_CODE_MAX - 1);
    settings->target_lang1[LANG_CODE_MAX - 1] = '\0';
    strncpy(settings->target_lang2, lang2, LANG_CODE_MAX - 1);
    settings->target_lang2[LANG_CODE_MAX - 1] = '\0';

    printf("settings: languages updated to target1=%s target2=%s (by speaker %u)\n",
