 ...
 */
/**
 * @param force  When true, skip non-empty/length validation (allows empty lang2).
 *               Used during REGISTER to accept languages from the admin phone.
 */
int settings_set_languages(Settings *settings, uint8_t speaker_id,
                           const char *lang1, const char *lang2, bool force);
